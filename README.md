<h1 data-importer="text" align="center">Jordan Ruedas 🚀</h1>

**Software Technology Engineering Student | Data Analyst & Data Science Enthusiast**
...
<div data-importer="techs" align="center">
  ...
  <!-- Mis iconos adicionales (que no quites) -->
  <img width="12" />
...
<div data-importer="socials" align="center">
  <a href="https://www.linkedin.com/in/jordan-emanuel-ruedas-vazquez-3289213a4/" target="_blank">
    <img src="https://img.shields.io/static/v1?message=LinkedIn&logo=linkedin&label=&color=0077B5&logoColor=white&labelColor=&style=for-the-badge" height="25" alt="linkedin logo" />
  </a>
  <a href="https://blog-web-blue-two.vercel.app/" target="_blank">
    <img src="https://img.shields.io/static/v1?message=Portfolio&logo=vercel&label=&color=000000&logoColor=white&labelColor=&style=for-the-badge" height="25" alt="vercel logo" />
  </a>
...
Hi there! I'm Jordan Ruedas, a passionate Software Technology Engineering student at FIME, UANL. My professional journey is driven by a curiosity to bridge the gap between **software development** and **data-driven decision making**.

My goal is to specialize as a **Data Analyst / Data Scientist**. I love building full-stack web systems, analyzing massive datasets, and developing AI-powered solutions. My portfolio reflects a constant evolution: from clean web interfaces (HTML/CSS/JS) to full-stack applications (Flask + MongoDB) and complex Machine Learning algorithms implemented from scratch.

I've had the privilege of working on **2 company-linked projects**, gaining real-world experience in software development and UX design. I'm currently looking for internship opportunities where I can apply my skills in Python, data analysis, and machine learning.

---

## 🛠️ Core Skills & Technologies

- **Languages:** Python 3.x, HTML, CSS, JavaScript, R
- **Frameworks & Libraries:** Flask, Jinja2, Pandas, NumPy, Matplotlib, Seaborn, scikit-learn, PyTorch, TensorFlow
- **Databases & Tools:** MongoDB, SQL (MySQL, PostgreSQL, SQLite, MS SQL Server), Git/GitHub, Power BI, Jupyter
- **Cloud & AI:** Google Cloud, AWS, Azure, Google Gemini API, Hugging Face Transformers, Fuzzy Logic
- **Methodologies:** Agile / Scrum, UML, ER Diagrams
- **Soft Skills:** Effective Communication, Teamwork, Adaptability, Critical Thinking, Problem Solving
...
- **🔗 GitHub:** [jordyruedas-a/compranet-analyst](https://github.com/jordyruedas-a/compranet-analyst)

### 🧠 PSA Practices — Adaptive PSO
Five advanced AI modules exploring intelligent traffic lights, K-Means from scratch, multi-agent auctions, and an Adaptive PSO algorithm with Fuzzy Logic.
- **Tech:** Python, NumPy, Fuzzy Logic, Threading, Tkinter, Matplotlib
...
- **Portfolio Web:** [blog-web-blue-two.vercel.app](https://blog-web-blue-two.vercel.app/)
