...
<div data-importer="techs" align="center">
  <!-- Fila 1: Lenguajes, Frameworks y Cloud -->
  ...
  <br>
  <br>
  <!-- Fila 3: Bases de datos, Herramientas y BI -->
...
- **Languages:** Python 3.x, R, HTML, CSS, JavaScript
...
- **Databases & Tools:** MongoDB, SQL (PostgreSQL, SQLite, MySQL, MS SQL Server), Git/GitHub, Power BI, Jupyter
- **AI & Advanced:** Google Gemini API, Hugging Face Transformers, Fuzzy Logic, Multi-agent Systems (Threading)
